	...
	switch(ddr_size){
		case 1 : /*2G DDR*/
			...
			__ddr_setting.t_pub0_dtar = ((0x0 + CONFIG_M8_DDR0_DTAR_DTCOL)| \
				((M8_DDR_DTAR_DTROW_GET(CONFIG_M8_DDR0_DTAR_ADDR,15,CONFIG_M8_DDR_COL_BITS,CONFIG_M8_DDR_AMBM_SET,CONFIG_M8_DDR_CHANNEL_SET)) <<12)| \
				((M8_DDR_DTAR_BANK_GET(CONFIG_M8_DDR0_DTAR_ADDR,15,CONFIG_M8_DDR_COL_BITS,CONFIG_M8_DDR_AMBM_SET,CONFIG_M8_DDR_CHANNEL_SET)) << 28));
			__ddr_setting.t_pub1_dtar = ((0x0 + CONFIG_M8_DDR1_DTAR_DTCOL)| \
				((M8_DDR_DTAR_DTROW_GET(CONFIG_M8_DDR1_DTAR_ADDR,15,CONFIG_M8_DDR_COL_BITS,CONFIG_M8_DDR_AMBM_SET,CONFIG_M8_DDR_CHANNEL_SET)) <<12)| \
				((M8_DDR_DTAR_BANK_GET(CONFIG_M8_DDR1_DTAR_ADDR,15,CONFIG_M8_DDR_COL_BITS,CONFIG_M8_DDR_AMBM_SET,CONFIG_M8_DDR_CHANNEL_SET)) << 28));
			__ddr_setting.t_mmc_ddr_ctrl = (__ddr_setting.t_mmc_ddr_ctrl & 0xfffff3f3) | (3<<10) | (3<<2);
			break;
		case 0 : /*1G DDR*/
			__ddr_setting.phy_memory_size = 0x40000000;
			__ddr_setting.t_pub0_dtar = ((0x0 + CONFIG_M8_DDR0_DTAR_DTCOL)| \
				((M8_DDR_DTAR_DTROW_GET(CONFIG_M8_DDR0_DTAR_ADDR,14,CONFIG_M8_DDR_COL_BITS,CONFIG_M8_DDR_AMBM_SET,CONFIG_M8_DDR_CHANNEL_SET)) <<12)| \
				((M8_DDR_DTAR_BANK_GET(CONFIG_M8_DDR0_DTAR_ADDR,14,CONFIG_M8_DDR_COL_BITS,CONFIG_M8_DDR_AMBM_SET,CONFIG_M8_DDR_CHANNEL_SET)) << 28));
			__ddr_setting.t_pub1_dtar = ((0x0 + CONFIG_M8_DDR1_DTAR_DTCOL)| \
				((M8_DDR_DTAR_DTROW_GET(CONFIG_M8_DDR1_DTAR_ADDR,14,CONFIG_M8_DDR_COL_BITS,CONFIG_M8_DDR_AMBM_SET,CONFIG_M8_DDR_CHANNEL_SET)) <<12)| \
				((M8_DDR_DTAR_BANK_GET(CONFIG_M8_DDR1_DTAR_ADDR,14,CONFIG_M8_DDR_COL_BITS,CONFIG_M8_DDR_AMBM_SET,CONFIG_M8_DDR_CHANNEL_SET)) << 28));
