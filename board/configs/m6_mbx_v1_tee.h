...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"bootargs=root=/dev/system rw rootfstype=ext3 rootwait init=/init console=ttyS0,115200n8 nohlt vmalloc=256m mem=1024m logo=osd1,0x84100000,720p\0" \
	"storage=null\0" \
