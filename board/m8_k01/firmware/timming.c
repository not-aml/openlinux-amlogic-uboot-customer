...
static struct ddr_set __ddr_setting={
	...
	.t_mmc_ddr_ctrl= (CONFIG_M8_DDR_CHANNEL_SET << 24) | //[B25,B24]:   ddr chanel selection. 
					...
					(CONFIG_M8_DDR3_CHAN1_ROW_SIZE<<10) |  //[B11,B10]: ddr1 row size.  2'b01 : A0~A12.	2'b10 : A0~A13.  2'b11 : A0~A14.  2'b00 : A0~A15. 
					(CONFIG_M8_DDR3_CHAN1_COL_SIZE<<8)	| //[B9,B8]: ddr1 col size.	2'b01 : A0~A8,	  2'b10 : A0~A9.  
					(0<<6)  |    //[B7,B6]: undefined
